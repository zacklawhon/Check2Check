    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; margin-top: 20px; background-color: #ffffff;">
        ...
        <tr>
            <td style="padding: 40px 30px;">
                ...
                <p style="color: #333333;">We're excited to help you take control of your finances. Click the button below to log in securely. This link will expire in 15 minutes.</p>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="center" style="padding: 20px 0;">
                            <a href="<?= $magicLink ?>" style="background-color: #4f46e5; color: #ffffff; padding: 15px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">Log In Now</a>
                        </td>
                    </tr>
                </table>
                ...
                <ul style="color: #333333; line-height: 1.6;">
                    ...
                    <li><b>Interactive Budgeting:</b> Track income, pay bills, and manage spending all in one place.</li>
                    <li><b>Category-Specific Details:</b> Track loan balances and credit card debt with specialized tools.</li>
                </ul>
