    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; margin-top: 20px; background-color: #ffffff;">
        ...
        <tr>
            <td style="padding: 40px 30px;">
                ...
                <p style="color: #333333;">Click the button below to log in securely. This link will expire in 15 minutes.</p>
                ...
                <?php if (isset($snapshotData)): ?>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f9f9f9; border: 1px solid #dddddd; margin-top: 20px;">
                        <tr>
                ...
                <p style="color: #333333; margin-top: 30px;">If you didn't request this, you can safely ignore this email.</p>
            </td>
        </tr>
        <tr>
